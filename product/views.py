...
from .models import Product, Cart, CartItem, Variation, Coupon, UsedCoupon, Wishlist
...
def cart(request, total=0, quantity=0, cart_items=None, reduction=0):
    ...
    return render(request, "stylaza/cart.html", context)
...
def remove_coupon(request):
    cou = request.session["coupon_code"]
    if cou:
